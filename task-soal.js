 ...
 */
const users = [
  { name:"satoru Gojo", age:27, major:"Teknik Hukum"},
  { name:"Toji", age:26, major:"Teknik Agama"},
  { name:"Nurul", age:22, major:"Pinjol Syariah"},
  { name:"Megumi", age:22, major:"Management Information"},
  { name:"Yuji Itadori", age:21, major:"Farmasi Narkotika"},
];
...
const store = async (user) => {
  ...
  // isi di sini
  users.push(
      {nama: "Sabiq", age: 20, major: "Informatics"}
  )
  await all(user)
